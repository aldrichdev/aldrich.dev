...
export const portfolioProjects: PortfolioProjectType[] = [
  {
    ...
    children: (
      <>
        ...
        typographies, so the design system's completion achieved their goals.
      </>
    ),
  ...
  },
  {
    ...
    children: (
      <>
        ...
        delivered an attractive new website that could show off their channel's shows and beautiful cover art.
      </>
    ),
  ...
  },
  {
    ...
    iconUrl: '/images/nextjs-icon.png',
    title: 'TimeTrax',
    technologies: 'Next.js, Vercel, TypeScript, Supabase, Tailwind CSS, Resend, Vercel v0, Cursor, WindSurf',
    children: (
      <>
        How fast can we create a time-tracking website using AI? That question was the starting point for this internal
        project. Shortly after joining the project, I became the lead developer and created email jobs, enhanced report
        exporting capabilities, standardized UIs and fixed bugs, utilizing AI tools like Vercel v0, Cursor and WindSurf.
      </>
    ),
  ...
  },
  {
    ...
    children: (
      <>
        ...
        were able to create an interactive touchscreen table for use at the client's location. I worked with a Unity
        developer to add new content to the table and iron out issues with the touch screen, and mentored them with my
        C# knowledge.
      </>
    ),
  },
