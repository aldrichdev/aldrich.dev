...
const AboutPage = () => {
  return (
    <section className='about-section'>
      <img src='/images/Paul.jpg' className='bio-photo' alt='Paul Aldrich' />
      <div>
        <h1>About Me</h1>
        <p>
          I've been working as a developer since 2012 on various projects. I started my career with C# and .NET
          development. My first job in industry was an IT internship, where I worked on a whole suite of Windows
        ...
        <p>
          If you'd like to see the projects I've worked on, check out my <a href='/portfolio'>portfolio page</a>.
        </p>
      </div>
    </section>
  )
